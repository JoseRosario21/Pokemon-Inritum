module QuestModule
  Chapter1 = {
    ...
    :Stage3 => "Choose your starter Pokémon.",
    :Stage4 => "Pick up the keys from the lobby.",
    :Stage5 => "Meet Meryl in Route 1 Park.",
    :Stage6 => "Investigate Feldspar Cave.",
    :Stage7 => "Report to Orion.",
    :Stage8 => "Battle Karl.",
  ...
  Chapter2 = {
    :ID => "5",
    :Name => "Chapter 2 - The Blind King",
    :QuestGiver => "nil",
    :Stage1 => "Travel to the Dark Forest",
    :Stage2 => "Go to Zapffe Falls",
    :Stage3 => "Help Howard with the cultists",
    ...
    :Location3 => "Zapffe Falls",
    :Location4 => "Zapffe Falls",
    :Location5 => "Zapffe Falls Cave",
    :Location6 => "Zapffe Falls",
    :Location7 => "Zapffe Falls",
    :Location8 => "Lumoria",
