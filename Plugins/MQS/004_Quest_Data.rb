module QuestModule
  Chapter1 = {
    :ID => "0",
    :Name => "Chapter 1 - To new beginnings",
    :QuestGiver => "nil",
    :Stage1 => "Meet Arthur at the Lab.",
    :Stage2 => "Obtain your starter Pokémon.",
    :Stage3 => "Pick up the keys from the lobby.",
    :Stage4 => "Meet Meryl in Route 1 Park.",
    :Stage5 => "Investigate Feldspar Cave.",
    :Stage6 => "Report to Orion.",
    :Stage7 => "Battle Karl.",
    :Stage8 => "Visit the School.",
    :Stage9 => "Pick the books Karl requested.",
    :Stage10 => "Defend the Lab.",
    :Stage10 => "You finished the demo!",
    :Location1 => "Stuot Lab",
    :Location2 => "Stuot Lab",
    :Location3 => "Olive Residency",
    :Location4 => "Route 1 Park",
    :Location5 => "Feldspar Cave",
    :Location6 => "Stuot Lab",
    :Location7 => "Stuot Lab",
