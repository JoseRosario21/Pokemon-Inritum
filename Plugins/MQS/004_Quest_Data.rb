module QuestModule
  ...
  Chapter3 = {
    ...
    :QuestGiver => "nil",
    :Stage1 => "Meet Carol at Lumoria's Poké Center",
    :Stage2 => "Get the first assignment from Robin",
    :Stage3 => "Go to Maria's house to help her study",
    :Stage4 => "Meet Maria at Lumoria's school",
    :Stage5 => "Report to Robin about the assignment",
    :Stage6 => "Pay a visit to the elderly couple",
    :Stage7 => "Use Bonsly in some battles",
    :Stage8 => "Give Bonsly back to Ida",
    :Stage9 => "Go on a walk with the elderly couple",
    :Stage10 => "Report to Robin about the 2nd assignment",
    :Stage11 => "Join forces with the police officer at night",
    :Stage12 => "Patrol the docks with Michael",
    :Stage13 => "Meet Michael again at night",
    :Stage14 => "Report to Robin about the 3rd assignment",
    :Stage15 => "Meet Richard to hear his request",
    :Stage16 => "Knock out 3 Combees",
    :Stage17 => "Find the apricorns",
    :Stage18 => "Gather 3 Kebia Berries",
    :Stage19 => "Search for the fresh bottle of Moomoo Milk",
    :Stage20 => "Join the party at Lumoria village square",
    :Stage21 => "Meet Robin to discuss the next steps",
    :Stage22 => "Investigate the abandoned church",
    :Stage23 => "Report to Robin",
    :Stage24 => "Help finding Albert",
    :Stage25 => "Investigate the temple",
    :Stage26 => "Stop the Aberration",
    :Stage27 => "Return to Robin",
    :Stage28 => "Challenge Robin to a Gym Battle",
    :Location1 => "Lumoria Poké Center",
    :Location2 => "Lumoria Help Center",
    :Location3 => "Maria's house",
    :Location4 => "Lumoria School",
    :Location5 => "Dark Forest",
    :Location6 => "Albert and Ida's house",
    :Location7 => "Dark Forest",
    :Location8 => "Albert and Ida's house",
    :Location9 => "Lumoria",
    :Location10 => "Lumoria Help Center",
    :Location11 => "Lumoria",
    :Location12 => "Lumoria Docks",
    :Location13 => "Lumoria Docks",
    :Location14 => "Lumoria Help Center",
    :Location15 => "Lumoria",
    :Location16 => "Dark Forest",
    :Location17 => "Dark Forest",
    :Location18 => "Dark Forest",
    :Location19 => "Dark Forest",
    :Location20 => "Lumoria",
    :Location21 => "Lumoria Poké Center",
    :Location22 => "Dark Forest",
    :Location23 => "Lumoria Help Center",
    :Location24 => "Dark Forest",
    :Location25 => "Ceryneian Temple",
    :Location26 => "Ceryneian Temple",
    :Location27 => "Lumoria Help Center",
    :Location28 => "Lumoria Gym",
