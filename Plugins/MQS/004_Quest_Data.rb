module QuestModule
  ...
  Chapter1_2 = {
    ...
    :QuestGiver => "nil",
    :Stage1 => "Go to Ostern Town.",
    :Stage2 => "Meet Karl at the park.",
    :Stage3 => "Meet Prof. Geoge",
    :Stage4 => "Conquer the first gym!",
    :Stage5 => "Report to Arthur.",
    :Stage6 => "Catch the Zeta Pokémon",
    :Location1 => "Ostern Town",
    :Location2 => "Ostern Park",
    :Location3 => "Ostern Hotel",
    :Location4 => "Ostern Gym",
    :Location5 => "Stuot Lab",
    :Location6 => "Andernach Island",
