...
# v3.1.1 by Boonzeet with code help from Maruno & Marin, Grass graphic by DaSpirit
# v21.1 port by JulieHaru
#-------------------------------------------------------------------------------
# Please give credit when using. Changes in this version:
# - Upgraded for Essentials v21.1
# - "Wings" items changed to "Feathers" items
#-------------------------------------------------------------------------------
# Configuration
#-------------------------------------------------------------------------------
# For Exp boost to work, please change the folloFEATHER line of
...
module PhenomenonConfig
  ...
  Items = {
    ...
    commonCave: %i[
      FIREGEM WATERGEM ICEGEM ELECTRICGEM GRASSGEM FIGHTINGGEM
    ...
    # 10% chance
    rareCave: %i[
      THUNDERSTONE WATERSTONE LEAFSTONE MOONSTONE FIRESTONE
      SUNSTONE SHINYSTONE DUSKSTONE DAWNSTONE EVERSTONE OVALSTONE
    ],
    bird: %i[
      HEALTHFEATHER RESISTFEATHER CLEVERFEATHER PRETTYFEATHER MUSCLEFEATHER GENIUSFEATHER SWIFTFEATHER
    ]
  }
end
