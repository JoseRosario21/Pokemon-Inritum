...
module Settings
  ...
  LEGENDARIES_HAVE_SOME_PERFECT_IVS   = true
  ...
  DAY_CARE_POKEMON_GAIN_EXP_FROM_WALKING     = false
  ...
  REPEL_COUNTS_FAINTED_POKEMON             = false
